...
class __TwigTemplate_00c3637f160edf73682d456d5331b238 extends Template
{
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Create new Notifications</h1>

    ";
        // line 8
        echo twig_include($this->env, $context, "notifications/_form.html.twig");
        echo "
...
{% block body %}
    <h1>Create new Notifications</h1>

    {{ include('notifications/_form.html.twig') }}

    <a href=\"{{ path('app_notifications_index') }}\">back to list</a>
{% endblock %}
