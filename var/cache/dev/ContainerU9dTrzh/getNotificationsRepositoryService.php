 ...
 */
class getNotificationsRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NotificationsRepository.php';

        return $container->privates['App\\Repository\\NotificationsRepository'] = new \App\Repository\NotificationsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
