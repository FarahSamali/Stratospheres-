 ...
 */
class getNotifyAlertRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NotifyAlertRepository' shared autowired service.
     *
     * @return \App\Repository\NotifyAlertRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NotifyAlertRepository.php';

        return $container->privates['App\\Repository\\NotifyAlertRepository'] = new \App\Repository\NotifyAlertRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
