 ...
 */
class getBanqueDeSangRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BanqueDeSangRepository' shared autowired service.
     *
     * @return \App\Repository\BanqueDeSangRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BanqueDeSangRepository.php';

        return $container->privates['App\\Repository\\BanqueDeSangRepository'] = new \App\Repository\BanqueDeSangRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
